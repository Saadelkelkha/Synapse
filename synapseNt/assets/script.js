  ...
  if(month.value == "1" || month.value == "3" || month.value == "5" || month.value == "7" || month.value == "8" || month.value == "10" || month.value == "12"){
    ...
    if(month.value == "4" || month.value == "6" || month.value == "9" || month.value == "11"){
      days.setAttribute("max", "30");
        ...
        iskabiss = (parseInt(year.value) % 4 === 0 && parseInt(year.value) % 100 !== 0) || (parseInt(year.value) % 400 === 0);
...
function handlePassword(){
  ...
  if (!passwordPattern.test(logpass)) {
    pass2error.innerText = "Veuillez entrez un format de mot de passe";
